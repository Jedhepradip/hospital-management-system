...
const HomePages: React.FC = () => {
  return (
    <div className="md:px-32 px-5 mt-5 mb-5">
      <div className="bg-blue-900 rounded-[20px] text-white min-h-screen flex flex-col md:flex-row items-center justify-between px-8 md:px-20 py-7">
        {/* Left Section */}
        <div className="max-w-lg">
          ...
          <button className="mt-6 flex items-center bg-white text-blue-900 px-5 py-2 rounded-full font-semibold text-lg shadow-lg hover:bg-gray-200 transition">
